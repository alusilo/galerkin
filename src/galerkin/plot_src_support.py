...
plt.plot(sx/1000,sy/1000,markerfacecolor='yellow', fillstyle='full', markeredgecolor='black', marker='*', markersize=15)
#plt.scatter(Xdata/1000,Ydata/1000,color='black', marker='.', s=80)
plt.imshow(Z.T[::-1,:], extent=[xmin/1000,xmax/1000,ymin/1000,ymax/1000], aspect='equal', cmap=cmap,vmin=0)
bar = plt.colorbar()
